...
grails.plugin.springsecurity.requestMap.className = 'projet.UserRole'
...
//redirect vers saleAd/index
grails.plugin.springsecurity.successHandler.alwaysUseDefault = true
grails.plugin.springsecurity.successHandler.defaultTargetUrl = '/saleAd/index'