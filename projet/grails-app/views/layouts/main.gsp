...
<body>
    ...
    <!--<div class="navbar navbar-default navbar-static-top" role="navigation">
        <div class="container">
		    ...
		    <asset:image src="filename.png" alt="Grails Logo"/>
                </a>
            </div>
...
<nav class="navbar navbar-light bg-light">
    <form class="form-inline">
        ...
        <button class="btn btn-outline-success" type="button" style="margin-right: 10px;"><a style="text-decoration: none;" href="/user/list">Liste des user</a></button>
